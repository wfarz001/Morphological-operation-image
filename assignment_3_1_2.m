...
se=ones(5, 5);
erodedBW = imdilate(b,se); %Image Dilation or Expansion
figure(3); imshow(erodedBW,[]); title('Image Dilation', 'FontSize', 15); 

%see the effective reduction in org,image
figure(4);imshow(b-erodedBW,[]);title('Effective Dilation in Binary Image', 'FontSize', 15);